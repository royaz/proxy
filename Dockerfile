...
RUN \
    ...
    ## traefik-real-ip
    wget -qO "/tmp/traefik-real-ip.tar.gz" https://github.com/soulbalz/traefik-real-ip/archive/refs/tags/v1.0.3.tar.gz; \
    mkdir -p /usr/local/bin/plugins-local/src/github.com/soulbalz/traefik-real-ip; \
